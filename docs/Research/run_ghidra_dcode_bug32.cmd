...
set "REPORT=%RESEARCH%DCodeBug32GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileDCodeBug32.py "%REPORT%"
